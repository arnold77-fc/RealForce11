(function () {
    ...
    // Вставь свою ссылку на сервер сюда, если нужно:
    ...
    function getBestJacred(movie, callback) {
        ...
        // ИСПРАВЛЕНО: Теперь ищет по оригиналу и чистит мусор, чтобы находило ВСЕ фильмы
    ...
    function checkUafixDirect(movie, callback) {
        ...
        fetchWithProxy(searchUrl, function (err, html) {
            ...
            // Восстановлена проверка кириллицы
