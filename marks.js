(function () {
        ...
        fetchWithProxy(apiUrl, function (err, body) {
            ...
            try {
                ...
                results.forEach(function (item) {
                    ...
                    if (t.indexOf('rus') >= 0 || t.indexOf('ru') >= 0) best.rus = true;
    ...
    function injectStyle() {
        ...
        style.innerHTML = '\
            ...
            .likhtar-marks-badge--ru  { background: linear-gradient(135deg, #d32f2f, #f44336); border-color: rgba(244,67,54,0.4); }\
            ...
            .likhtar-marks-full-badge--ru { background: linear-gradient(135deg, #d32f2f, #f44336); border-color: rgba(244,67,54,0.4); }\
